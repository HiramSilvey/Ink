...
player can fart "" if "player property comfort is uncomfortable" then "describe 'you cut the cheese'" "player get cubes"
...
player can use slats if "outdoors has player" then "describe 'you arrange the slats to make a pen'" "player get pen"
...
player can tar key if 'all "outside has player" "player has key"' then 'describe "You just made a keytar. Awww yea"' "player get keytar" "player drop key"
