(defproject ink "0.0.1-SNAPSHOT"
  :description "A framework for interactive text adventure games."
  :url "https://github.com/Hiram-Silvey/Ink"
  ...
  {:builds {;; This build is only used for including any cljs source
            ...
            {:source-paths ["src/cljs"]
             ...
             ;; Compilation Options
             :compiler
             {:output-to "dev-resources/public/js/ink.js"
